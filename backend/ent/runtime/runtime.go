...
func init() {
	...
	// usagelogDescAttemptCount is the schema descriptor for attempt_count field.
	usagelogDescAttemptCount := usagelogFields[32].Descriptor()
	// usagelog.DefaultAttemptCount holds the default value on creation for the attempt_count field.
	usagelog.DefaultAttemptCount = usagelogDescAttemptCount.Default.(int)
	// usagelogDescFailoverCount is the schema descriptor for failover_count field.
	usagelogDescFailoverCount := usagelogFields[33].Descriptor()
	// usagelog.DefaultFailoverCount holds the default value on creation for the failover_count field.
	usagelog.DefaultFailoverCount = usagelogDescFailoverCount.Default.(int)
