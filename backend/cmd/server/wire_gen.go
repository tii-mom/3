...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	voucherService := service.NewVoucherService(db, settingRepository, totpService)
