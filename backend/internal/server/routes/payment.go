...
func RegisterPaymentRoutes(
	...
	adminGroup.Use(middleware.AdminComplianceGuard(settingService))
	{
		...
		adminOrders := adminGroup.Group("/orders")
		{
			...
			adminOrders.POST("/:id/sync-subscription-keys", adminPaymentHandler.SyncSubscriptionKeyBindings)
			adminOrders.POST("/:id/confirm-subscription", adminPaymentHandler.ConfirmSubscriptionPayment)
		...
		plans := adminGroup.Group("/plans")
		{
			...
			plans.POST("/sync", adminPaymentHandler.SyncSubscriptionPlans)
