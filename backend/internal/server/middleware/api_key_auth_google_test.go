...
func TestApiKeyAuthWithSubscriptionGoogle_SubscriptionLimitExceededFallsBackToBilling(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
func TestApiKeyAuthWithSubscriptionGoogle_SubscriptionLimitExceededRejectsWhenBalanceExhausted(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	apiKey := &service.APIKey{
		ID:     501,
		UserID: user.ID,
		Key:    "google-sub-limit-exhausted",
		Status: service.StatusActive,
		User:   user,
		Group:  group,
	}
