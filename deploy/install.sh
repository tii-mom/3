...
declare -A MSG_ZH=(
    ...
    # Completion
    ["install_complete"]="3API 安装完成！"
    ["install_dir"]="安装目录"
    ["next_steps"]="后续步骤"
    ["step1_check_services"]="确保 PostgreSQL 和 Redis 正在运行："
    ["step2_start_service"]="启动 3API 服务："
    ...
    ["not_installed"]="3API 尚未安装，请先执行全新安装"
    ["fresh_install_hint"]="用法"

    # Uninstall
    ["uninstall_confirm"]="这将从系统中移除 3API。"
    ...
    ["server_config_desc"]="配置 3API 服务监听地址"
...
declare -A MSG_EN=(
    ...
    # Installation
    ["install_title"]="3API Installation Script"
    ...
    # Completion
    ["install_complete"]="3API installation completed!"
    ["install_dir"]="Installation directory"
    ["next_steps"]="NEXT STEPS"
    ["step1_check_services"]="Make sure PostgreSQL and Redis are running:"
    ["step2_start_service"]="Start 3API service:"
    ...
    ["not_installed"]="3API is not installed. Please run a fresh install first"
    ["fresh_install_hint"]="Usage"

    # Uninstall
    ["uninstall_confirm"]="This will remove 3API from your system."
    ...
    ["uninstall_complete"]="3API has been uninstalled"

    # Help
    ["usage"]="Usage"
    ["cmd_none"]="(none)"
    ["cmd_install"]="Install 3API"
    ["cmd_upgrade"]="Upgrade to the latest version"
    ["cmd_uninstall"]="Remove 3API"
    ...
    ["server_config_desc"]="Configure 3API server listen address"
