export default {
  ...
  finance: {
    ...
    distribution: { title: '算力公司', subtitle: '团队业绩、公司收益与提现', overview: '概览', team: '团队', ledger: '公司收益流水', withdraw: '提现与兑换', unitOverview: '五个部门运营概览', teamStructure: '团队结构', teamStructureHint: '点击结构条查看对应成员明细', teamSegmentDirect: '直连成员', teamSegmentExpanded: '扩展成员', teamSegmentCollaboration: '协同成员', teamSegmentEcosystem: '生态成员', teamSegmentSupport: '支撑成员', analyticsTitle: '收益与业绩趋势', analyticsHint: '按自然日汇总真实充值和公司收益', analyticsNoData: '暂无足够的经营数据', analyticsForecast: '趋势预估', analyticsForecastHint: '根据近期有效数据推算，不参与收益结算', nextWeek: '下一周', nextMonth: '下一个月', forecastUnavailable: '数据不足，暂不预测', forecastInsufficientHistory: '历史数据不足', forecastInsufficientActivity: '有效经营日不足', growth: '预计变化', asOf: '数据截至', range7d: '7日', range30d: '30日', range90d: '90日', periodComparison: '较上一周期', previewDataBadge: '本地演示数据', previewDataNotice: '当前页面使用本地演示数据，仅用于查看图标和信息布局；关闭预览参数后恢复真实接口数据。', previewDataReadOnly: '演示数据为只读，未提交任何真实提现或兑换操作。', teamVolume: '团队业绩', companyMembers: '公司成员', activeUnits: '活跃单元', currentTier: '当前档位', effectiveTier: '生效档位', autoTier: '自动档位', manualTier: '手动档位', manual: '手动', lifetimeEarned: '累计收益', withdrawing: '提现中', tiers: '收益档位', tier: '档位', threshold: '业绩门槛', tierStatus: '当前生效档位 T{tier}；手动档位可在未达到门槛时提前生效。', rateSnapshot: '当前购买比例：1 CNY = {rate} USD，兑换平台额度按后台余额充值倍率计算。', companyMembersTitle: '公司成员', companySummary: '公司业绩与收益', companyUnit: '公司部门', companyUnits: { coreCompute: '核心算力部', channelGrowth: '渠道拓展部', applicationAccess: '应用接入部', ecosystemPartnerships: '生态合作部', infrastructureSupport: '基础支撑部' }, memberCount: '人数', member: '成员', directChildren: '直推人数', recharge: '充值业绩', availableCommission: '可用收益', frozenCommission: '冻结收益', backToTeam: '返回我的团队', viewTeam: '查看下属团队', order: '订单', rate: '比例', commission: '公司收益', payout: '支付宝收款账户', realName: '姓名', alipay: '支付宝账号', submitWithdrawal: '提交提现', me: '本人', net: '实际打款', debt: '收益债务', inviteTitle: '分享入口', inviteSubtitle: '邀请码继续用于建立团队关系，收益统一进入算力公司钱包。', inviteCode: '邀请码', inviteLink: '分享链接', copy: '复制', copied: '已复制', historicalBalance: '历史余额 {amount} 仍保留在兼容账本，可单独结转。', transferHistorical: '结转历史余额', walletRules: '钱包规则', freezePeriod: '冻结期', minimumWithdrawal: '最低提现', dailyWithdrawalLimit: '每日提现次数', withdrawRuleHint: '冻结期 {hours} 小时；最低 {minimum}；每个自然日最多提交 {dailyLimit} 次。', convertTitle: '兑换平台额度', convertRate: '按 1 CNY = {rate} USD 兑换，所得平台额度不可提现或反向兑换。', convertHint: '请输入要兑换的人民币收益金额，不能超过可用余额。', convertPreview: '预计获得 {amount} USD 平台额度', convertButton: '兑换为平台额度', converted: '已兑换 {amount} USD', cnyAmount: '人民币金额', usdAmount: '平台额度', exchangeRate: '购买比例', createdAt: '创建时间', shareCardTitle: '把你的算力公司分享出去', shareCardSubtitle: '生成一张品牌分享海报，扫码即可注册并加入你的算力公司。', createShareCard: '生成分享海报', copyLink: '复制分享链接', shareCardPreview: '分享海报预览', shareCardAlt: '3API 算力公司分享海报', shareCardHint: '二维码只包含注册邀请链接，不会展示余额、收益或邮箱等隐私信息。', downloadShareCard: '下载图片', copyShareCard: '复制图片', shareCardPrivacy: '图片适合直接发送到群聊或社交平台。', shareCardPosterHint: '扫码注册，加入我的算力公司', scanToJoin: '扫码加入算力公司', shareCardCopied: '分享图片已复制' },
