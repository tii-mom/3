export default {
  ...
  finance: {
    ...
    ,partner: { title: 'SaaS 合作伙伴', subtitle: '白牌 SaaS 招商计划将单独打磨后发布。', pausedTitle: 'SaaS 招商暂未开放', pausedDesc: '这一版本先聚焦算力公司五级分销、首充赠额、提现和额度兑换码。白牌 SaaS 会拆成独立的招商面板、租户后台和平台管理后台后再开放。', value1: '使用自己的品牌和域名', value2: '终端用户走商户自己的支付渠道', value3: '3API 提供上游号池、网关和托管部署', contactHint: '如需提前沟通试点名额，请联系平台运营。', withdrawing: '提现中', siteName: '站点名称', retailMultiplier: '零售倍率', paymentProvider: '支付渠道', paymentConfig: '支付渠道配置' }
  },
