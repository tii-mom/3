export default {
  ...
  finance: {
    ...
    distribution: { title: '算力公司', subtitle: '团队业绩、部门绩效与提现', overview: '概览', team: '团队', ledger: '佣金明细', withdraw: '提现', teamVolume: '团队业绩', currentTier: '当前档位', tiers: '返佣档位', tier: '档位', threshold: '业绩门槛', levels: '部门成员分布', order: '订单', depth: '部门层级', rate: '比例', commission: '佣金', payout: '支付宝收款账户', realName: '姓名', alipay: '支付宝账号', submitWithdrawal: '提交提现', me: '本人', net: '实际打款', debt: '佣金债务' },
    admin: { title: '财务运营', withdrawals: '提现审核', vouchers: '兑换码风控', commissions: '佣金对账', recharges: '充值与首充', relations: '部门组织架构', approve: '批准', paid: '确认打款', reject: '拒绝', reason: '原因', reference: '打款流水号', lock: '冻结', unlock: '解冻', payoutDetails: '收款详情', securityFields: '安全操作信息', bucketShadow: '额度桶影子模式', bucketEnforced: '额度桶已生效', policy: '绩效政策版本', version: '版本', freezeHours: '冻结小时', dailyLimit: '每日提现次数', feeBps: '提现费率（bps）', bonusBps: '首充奖励（bps）', bonusCap: '首充奖励上限（USD）', legacyStack: '叠加旧返利', publishPolicy: '发布新版本', reverseChargeback: '拒付冲正', reversalSecurityRequired: '请输入 TOTP 和冲正原因', reverseChargebackConfirm: '确认冲正该笔充值、首充赠额、团队业绩及全部关联佣金？' },
    ...
    ,partner: { title: 'SaaS 合作伙伴', subtitle: '白牌 SaaS 招商计划将单独打磨后发布。', pausedTitle: 'SaaS 招商暂未开放', pausedDesc: '这一版本先聚焦算力公司部门组织架构、首充赠额、提现和额度兑换码。白牌 SaaS 会拆成独立的招商面板、租户后台和平台管理后台后再开放。', value1: '使用自己的品牌和域名', value2: '终端用户走商户自己的支付渠道', value3: '3API 提供上游号池、网关和托管部署', contactHint: '如需提前沟通试点名额，请联系平台运营。', withdrawing: '提现中', siteName: '站点名称', retailMultiplier: '零售倍率', paymentProvider: '支付渠道', paymentConfig: '支付渠道配置' }
  },
