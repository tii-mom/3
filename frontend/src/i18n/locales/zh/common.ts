export default {
  ...
  finance: {
    ...
    distribution: { title: '算力公司', subtitle: '团队业绩、公司收益与提现', overview: '概览', team: '团队', ledger: '佣金明细', withdraw: '提现', teamVolume: '团队业绩', companyMembers: '公司成员', activeUnits: '活跃单元', currentTier: '当前档位', effectiveTier: '生效档位', autoTier: '自动档位', manualTier: '手动档位', manual: '手动', lifetimeEarned: '累计收益', withdrawing: '提现中', tiers: '返佣档位', tier: '档位', threshold: '业绩门槛', tierStatus: '当前生效档位 T{tier}；手动档位可在未达到门槛时提前生效。', companyMembersTitle: '公司成员', companySummary: '公司业绩与收益', companyUnit: '公司单元', companyUnits: { coreCompute: '核心算力部', channelGrowth: '渠道拓展部', applicationAccess: '应用接入部', ecosystemPartnerships: '生态合作部', infrastructureSupport: '基础支撑部' }, memberCount: '人数', member: '成员', directChildren: '直推人数', recharge: '充值业绩', availableCommission: '可用收益', frozenCommission: '冻结收益', backToTeam: '返回我的团队', viewTeam: '查看下属团队', order: '订单', rate: '比例', commission: '佣金', payout: '支付宝收款账户', realName: '姓名', alipay: '支付宝账号', submitWithdrawal: '提交提现', me: '本人', net: '实际打款', debt: '佣金债务' },
    admin: { title: '财务运营', tierAssignments: '档位指定', tierSearchPlaceholder: '按邮箱或用户名搜索用户', tierAssignmentHint: '可指定 T1/T2/T3，未达到对应业绩门槛的用户也可提前生效；清除后恢复自动档位。', user: '用户', automatic: '自动', withdrawals: '提现审核', vouchers: '兑换码风控', commissions: '佣金对账', recharges: '充值与首充', relations: '公司关系', approve: '批准', paid: '确认打款', reject: '拒绝', reason: '原因', reference: '打款流水号', lock: '冻结', unlock: '解冻', payoutDetails: '收款详情', securityFields: '安全操作信息', bucketShadow: '额度桶影子模式', bucketEnforced: '额度桶已生效', policy: '公司收益政策版本', version: '版本', freezeHours: '冻结小时', dailyLimit: '每日提现次数', feeBps: '提现费率（bps）', bonusBps: '首充奖励（bps）', bonusCap: '首充奖励上限（USD）', legacyStack: '叠加旧返利', publishPolicy: '发布新版本', reverseChargeback: '拒付冲正', reversalSecurityRequired: '请输入 TOTP 和冲正原因', reverseChargebackConfirm: '确认冲正该笔充值、首充赠额、团队业绩及全部关联佣金？' }
  },
