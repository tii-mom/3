export default {
    ...
    channels: {
      ...
      form: {
        ...
        codexImageGenerationBridgeHint: '开启后，OpenAI 分组会为 Codex /responses 文本请求注入 hosted image_generation 工具，并替换客户端本地 image_gen 声明；带图片工具的 Responses Lite 请求会升级为标准 Responses。仅在路由账号支持图片生成时开启。',
