export default {
  ...
  subscriptionProgress: {
    ...
    monthly: '每月',
    remaining: '剩余',
    dailyRemaining: '今日剩余额度',
    weeklyRemaining: '本周剩余额度',
    monthlyRemaining: '本月剩余额度',
    usedAmount: '已使用 {amount}',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 3API',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">3API 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 3API 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 3API',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 3API AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
  ...
  payment: {
    ...
    admin: {
      ...
      retry: '重试',
      retrySuccess: '重试成功',
      confirmSubscriptionPayment: '确认收款',
      confirmSubscriptionPaymentPrompt: '确认已收到 {amount}？确认后订单 {order} 会立即开通订阅。',
      confirmSubscriptionPaymentSuccess: '已确认收款并开通订阅',
      approveRefund: '批准退款',
      retryRefund: '重试退款',
      ...
      planName: '套餐名称',
      planNamePlaceholder: '例如：月度 Pro 套餐',
      planDescription: '套餐描述',
      planDescriptionPlaceholder: '例如：适合日常 API 调用和模型测试',
      createPlan: '创建套餐',
      syncPlans: '同步订阅分组',
      syncPlansHint: '为尚未配置套餐的订阅分组生成不可售草稿',
      syncPlansResult: '已生成 {count} 个套餐草稿，请补充价格后上架',
      editPlan: '编辑套餐',
      deletePlan: '删除套餐',
      ...
      price: '售价',
      salePriceCny: '售卖金额（元）',
      originalPriceCny: '原价（元）',
      planBenefitGroup: '订阅权益',
      planAutoFulfillHint: '用户付款后系统会自动开通订阅；人工收款可在订单管理里确认。',
      currency: '币种标注',
      ...
      plansPageKicker: '订阅售卖',
      plansPageTitle: '订阅套餐',
      plansPageDesc: '在这里创建 ¥10、¥20、¥50 等订阅套餐。上架后，用户可在充值/订阅页面直接付款购买，支付成功自动开通。',
      planSaleStepCreate: '1. 创建套餐',
      planSaleStepBind: '2. 绑定权益',
      planSaleStepPrice: '3. 设置售价',
      planSaleStepPublish: '4. 开启上架',
      planSaleStepAuto: '5. 付款后自动开通',
      tabPlanConfig: '套餐配置',
      tabUserSubs: '用户订阅',
      selectGroup: '请选择分组',
