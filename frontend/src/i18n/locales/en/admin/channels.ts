export default {
    ...
    channels: {
      ...
      form: {
        ...
        codexImageGenerationBridgeHint: 'When enabled, Codex /responses text requests in OpenAI groups receive the hosted image_generation tool and local image_gen declarations are replaced. Lite requests carrying image tools are promoted to standard Responses. Leave this off unless routed accounts support image generation.',
