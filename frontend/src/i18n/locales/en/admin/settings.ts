export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for 3API end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for 3API end-user login',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve billing rates declared by upstream sites connected to OpenAI API keys.',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: '3API',
        siteNameHint: 'Displayed in emails and page titles',
        siteSubtitle: 'Site Subtitle',
        siteSubtitlePlaceholder: 'AI API gateway for unified model access',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on 3API orders; the upstream type is sent as EasyPay type.',
