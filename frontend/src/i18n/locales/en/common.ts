export default {
  ...
  finance: {
    ...
    distribution: { title: 'Compute Company', subtitle: 'Team volume, company earnings, and payouts', overview: 'Overview', team: 'Team', ledger: 'Commission ledger', withdraw: 'Withdraw', teamVolume: 'Team volume', companyMembers: 'Company members', activeUnits: 'Active units', currentTier: 'Current tier', effectiveTier: 'Effective tier', autoTier: 'Automatic tier', manualTier: 'Manual tier', manual: 'Manual', lifetimeEarned: 'Lifetime earned', withdrawing: 'Withdrawing', tiers: 'Commission tiers', tier: 'Tier', threshold: 'Performance gate', tierStatus: 'Effective tier T{tier}; a manual tier can take effect before its gate is reached.', companyMembersTitle: 'Company members', companySummary: 'Company performance and earnings', companyUnit: 'Company unit', companyUnits: { coreCompute: 'Core Compute', channelGrowth: 'Channel Growth', applicationAccess: 'Application Access', ecosystemPartnerships: 'Ecosystem Partnerships', infrastructureSupport: 'Infrastructure Support' }, memberCount: 'Members', member: 'Member', directChildren: 'Direct members', recharge: 'Recharge volume', availableCommission: 'Available earnings', frozenCommission: 'Frozen earnings', backToTeam: 'Back to my team', viewTeam: 'View team', order: 'Order', rate: 'Rate', commission: 'Commission', payout: 'Alipay payout account', realName: 'Real name', alipay: 'Alipay account', submitWithdrawal: 'Submit withdrawal', me: 'Me', net: 'Net payout', debt: 'Commission debt' },
    admin: { title: 'Finance Operations', tierAssignments: 'Tier assignments', tierSearchPlaceholder: 'Search by email or username', tierAssignmentHint: 'Assign T1/T2/T3 before the performance gate is reached. Clear the assignment to restore automatic tiering.', user: 'User', automatic: 'Automatic', withdrawals: 'Withdrawals', vouchers: 'Voucher risk', commissions: 'Commission audit', recharges: 'Recharge and bonus', relations: 'Company relationships', approve: 'Approve', paid: 'Confirm paid', reject: 'Reject', reason: 'Reason', reference: 'Payment reference', lock: 'Lock', unlock: 'Unlock', payoutDetails: 'Payout details', securityFields: 'Secure operation fields', bucketShadow: 'Credit buckets in shadow mode', bucketEnforced: 'Credit buckets enforced', policy: 'Company earnings policy version', version: 'Version', freezeHours: 'Freeze hours', dailyLimit: 'Daily withdrawal limit', feeBps: 'Withdrawal fee (bps)', bonusBps: 'First recharge bonus (bps)', bonusCap: 'First recharge bonus cap (USD)', legacyStack: 'Stack legacy rebate', publishPolicy: 'Publish new version', reverseChargeback: 'Reverse chargeback', reversalSecurityRequired: 'TOTP and a reversal reason are required', reverseChargebackConfirm: 'Reverse this recharge, bonus, team volume, and every related commission?' }
  },
