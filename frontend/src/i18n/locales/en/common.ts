export default {
  ...
  finance: {
    ...
    distribution: { title: 'Compute Company', subtitle: 'Team volume, company earnings, and payouts', overview: 'Overview', team: 'Team', ledger: 'Company earnings ledger', withdraw: 'Withdraw and convert', unitOverview: 'Five department operations', teamStructure: 'Team structure', teamStructureHint: 'Select a structure bar to view matching members', teamSegmentDirect: 'Direct members', teamSegmentExpanded: 'Expanded members', teamSegmentCollaboration: 'Collaborating members', teamSegmentEcosystem: 'Ecosystem members', teamSegmentSupport: 'Support members', analyticsTitle: 'Earnings and volume trend', analyticsHint: 'Daily totals from confirmed recharges and company earnings', analyticsNoData: 'Not enough operating data yet', analyticsForecast: 'Trend forecast', analyticsForecastHint: 'Estimated from recent activity; never used for settlement', nextWeek: 'Next 7 days', nextMonth: 'Next 30 days', forecastUnavailable: 'Not enough data to forecast', forecastInsufficientHistory: 'Insufficient history', forecastInsufficientActivity: 'Insufficient active days', growth: 'Expected change', asOf: 'Data as of', range7d: '7 days', range30d: '30 days', range90d: '90 days', periodComparison: 'vs previous period', previewDataBadge: 'Local preview data', previewDataNotice: 'This page uses local preview data to demonstrate the icon and information layout. Remove the preview query to use live API data.', previewDataReadOnly: 'Preview data is read-only. No real withdrawal or conversion was submitted.', teamVolume: 'Team volume', companyMembers: 'Company members', activeUnits: 'Active units', currentTier: 'Current tier', effectiveTier: 'Effective tier', autoTier: 'Automatic tier', manualTier: 'Manual tier', manual: 'Manual', lifetimeEarned: 'Lifetime earned', withdrawing: 'Withdrawing', tiers: 'Earnings tiers', tier: 'Tier', threshold: 'Performance gate', tierStatus: 'Effective tier T{tier}; a manual tier can take effect before its gate is reached.', rateSnapshot: 'Current purchase ratio: 1 CNY = {rate} USD. Platform credit follows the balance recharge multiplier.', companyMembersTitle: 'Company members', companySummary: 'Company performance and earnings', companyUnit: 'Company department', companyUnits: { coreCompute: 'Core Compute', channelGrowth: 'Channel Growth', applicationAccess: 'Application Access', ecosystemPartnerships: 'Ecosystem Partnerships', infrastructureSupport: 'Infrastructure Support' }, memberCount: 'Members', member: 'Member', directChildren: 'Direct members', recharge: 'Recharge volume', availableCommission: 'Available earnings', frozenCommission: 'Frozen earnings', backToTeam: 'Back to my team', viewTeam: 'View team', order: 'Order', rate: 'Rate', commission: 'Company earnings', payout: 'Alipay payout account', realName: 'Real name', alipay: 'Alipay account', submitWithdrawal: 'Submit withdrawal', me: 'Me', net: 'Net payout', debt: 'Earnings debt', inviteTitle: 'Sharing', inviteSubtitle: 'The invite code still establishes team relationships; all rewards settle into the Compute Company wallet.', inviteCode: 'Invite code', inviteLink: 'Share link', copy: 'Copy', copied: 'Copied', historicalBalance: 'Historical balance {amount} remains in the compatibility ledger and can be transferred separately.', transferHistorical: 'Transfer historical balance', walletRules: 'Wallet rules', freezePeriod: 'Freeze period', minimumWithdrawal: 'Minimum withdrawal', dailyWithdrawalLimit: 'Daily submissions', withdrawRuleHint: '{hours}-hour freeze; minimum {minimum}; at most {dailyLimit} submission(s) per natural day.', convertTitle: 'Convert platform balance', convertRate: 'At 1 CNY = {rate} USD; converted balance cannot be withdrawn or converted back.', convertHint: 'Enter the CNY earnings amount to convert, up to the available balance.', convertPreview: 'Estimated platform balance: {amount} USD', convertButton: 'Convert to platform balance', converted: 'Converted {amount} USD', cnyAmount: 'CNY amount', usdAmount: 'Platform balance', exchangeRate: 'Purchase ratio', createdAt: 'Created', shareCardTitle: 'Share your Compute Company', shareCardSubtitle: 'Generate a branded invitation card. A scan opens registration and joins your Compute Company.', createShareCard: 'Generate share card', copyLink: 'Copy share link', shareCardPreview: 'Share card preview', shareCardAlt: '3API Compute Company invitation card', shareCardHint: 'The QR code contains only the registration invite link. No balance, earnings, or email data is shown.', downloadShareCard: 'Download image', copyShareCard: 'Copy image', shareCardPrivacy: 'The image is ready for group chats and social sharing.', shareCardPosterHint: 'Scan to register and join my Compute Company', scanToJoin: 'Scan to join the Compute Company', shareCardCopied: 'Share image copied' },
