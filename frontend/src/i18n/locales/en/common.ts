export default {
  ...
  finance: {
    ...
    ,partner: { title: 'SaaS Partner', subtitle: 'The white-label SaaS partner program will ship separately after refinement.', pausedTitle: 'SaaS recruitment is not open yet', pausedDesc: 'This release focuses on Compute Company department structure, first recharge bonus, payouts, and balance vouchers. White-label SaaS will be split into a recruitment panel, tenant console, and platform admin before release.', value1: 'Use your own brand and domain', value2: 'End-user payments settle to the merchant account', value3: '3API provides upstream pools, gateway, and managed deployment', contactHint: 'Contact platform operations if you want to discuss an early pilot.', withdrawing: 'Withdrawing', siteName: 'Site name', retailMultiplier: 'Retail multiplier', paymentProvider: 'Payment provider', paymentConfig: 'Payment configuration' }
  },
