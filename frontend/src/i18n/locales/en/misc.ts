export default {
  ...
  userSubscriptions: {
    ...
    weeklyRemaining: 'This week remaining',
    monthlyRemaining: 'This month remaining',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to 3API',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">3API is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of 3API, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to 3API',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the 3API AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
  ...
  payment: {
    ...
    admin: {
      ...
      confirmSubscriptionPaymentPrompt: 'Confirm that {amount} has been received? Order {order} will be fulfilled immediately.',
      confirmSubscriptionPaymentSuccess: 'Payment confirmed and subscription activated',
      ...
      planName: 'Plan Name',
      planNamePlaceholder: 'e.g. Monthly Pro Plan',
      planDescription: 'Plan Description',
      planDescriptionPlaceholder: 'e.g. Good for daily API usage and model testing',
      createPlan: 'Create Plan',
      syncPlans: 'Sync Subscription Groups',
      syncPlansHint: 'Create disabled drafts for subscription groups without a plan',
      syncPlansResult: 'Created {count} plan drafts. Add prices before putting them on sale.',
      editPlan: 'Edit Plan',
      deletePlan: 'Delete Plan',
      deletePlanConfirm: 'Are you sure you want to delete this plan?',
      originalPrice: 'Original Price',
      price: 'Sale Price',
      salePriceCny: 'Sale Amount (CNY)',
      originalPriceCny: 'Original Price (CNY)',
      planBenefitGroup: 'Subscription Benefit',
      planAutoFulfillHint: 'After user payment, the subscription is opened automatically. Offline collection can be confirmed in Orders.',
      ...
      plansPageKicker: 'Subscription sales',
      plansPageTitle: 'Subscription Plans',
      plansPageDesc: 'Create ¥10, ¥20, ¥50 subscription plans here. After publishing, users can pay on the Recharge / Subscription page and activation is automatic.',
      planSaleStepCreate: '1. Create plan',
      planSaleStepBind: '2. Bind benefit',
      planSaleStepPrice: '3. Set price',
      planSaleStepPublish: '4. Publish',
      planSaleStepAuto: '5. Auto activate',
