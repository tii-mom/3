...
export interface DistributionConversion { id: number; amount_cny_minor: number; usd_amount: string; usd_to_cny_rate: string; config_version: number; created_at: string }
